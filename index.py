...
@app.route('/ultimo')
def ultimo():
    return render_template('ultimo.html')
...
def calcularCuadradosMedios():
    ...
    data= df.to_html(classes="table table-light table-striped", justify="justify-all", border=5)
...
def calcularPromedioMovil():
    ...
    data= df.to_html(classes="table table-striped", justify="justify-all", border=5)
...
def calcularMontecarlo():
    ...
    data= x2.to_html(classes="table table-striped", justify="justify-all", border=5)
    ...
    data2= dfMCL.to_html(classes="table table-striped", justify="justify-all", border=5)
...
def calcularSistemaInventario():
    ...
    data2 = dfQ.to_html(classes="table table-striped", justify="justify-all", border=5)
    ...
    data3 = df.to_html(classes="table table-striped", justify="justify-all", border=0)
...
def calcularLineaEspera():
    ...
    data2= dfLE.to_html(classes="table table-striped", justify="justify-all", border=5)
    ...
    data3 = dfLE2.to_html(classes="table table-striped", justify="justify-all", border=5)
...
def calcularMED():
    ...
    #datos.to_html()
    datohtml = datos.to_html(classes="table table-light table-striped", justify="justify-all", border=5)
    ...
    data2 = df2.to_html(classes="table table-light table-striped", justify="justify-all", border=5)
